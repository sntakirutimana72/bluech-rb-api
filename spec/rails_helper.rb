...
RSpec.configure do |config|
  # Include Active Record Test Helpers in all test fixtures
  config.include ActiveRecordTestHelpers

  # Include JWT Authorization Test Helpers only in [:request, :channel] test fixtures
  config.include AuthenticationTestHelpers::DeviseJWTStrategy, type: :request
  config.include AuthenticationTestHelpers::DeviseJWTStrategy, type: :channel
